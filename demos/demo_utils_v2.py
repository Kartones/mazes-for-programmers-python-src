...
# TODO: Change naming
def available_algorithm(algorithm: str, available_algorithms: List[str]) -> Algorithm:
...
# TODO: Change naming
def available_exporter(exporter: str, available_exporters: List[str]) -> Exporter:
